...
namespace Pretty.Localisation
{
    ...
    {
        static readonly ResourceManager ResourceManager = new ResourceManager("Pretty.Properties.Resources", typeof(Resources).Assembly);
